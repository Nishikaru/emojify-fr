    ...
    <div className="h-screen w-full overflow-hidden">
      ...
      <div className="py-24 px-6 flex flex-col gap-12 items-center h-full overflow-auto">
        <form className="flex gap-6">
          <select
            className="p-2 text-lg font-normal rounded-lg"
            name="categories"
            id="categories"
          >
          ...
          <button className="flex items-center gap-4 p-2 bg-sky-300 rounded-lg">
            <span>Filter</span> <FiFilter />
          </button>
        </form>
        <div className="w-full flex flex-col gap-6">
          <h3 className="text-lg font-medium bg-sky-300/50 p-2 rounded-lg flex justify-between">
            <span>Anime</span>
            <span>70</span>
          </h3>
